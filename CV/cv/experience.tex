...
\begin{cventries}
  ...
  {Aug. 2023 - present}
  {
    \begin{cvparagraph}
     ...
     \end{cvparagraph}
  \begin{cvitems}
    \item{FORGE: Develop electromagnetic inversion methodologies using charged well casings sources.}
    \item{Level Set: implement a generalized level set inversion methodology in an open source platform, for the context of
    monitoring carbon capture and storage.
    }
    \vspace{10pt}
    \end{cvitems}
    \begin{cvparagraph}
     ...
     \end{cvparagraph}
  \begin{cvitems}
    \item {GPGN 318 - Applied Geophysics 1: Teach introduction to surveying, gravity, electrical, and magnetics methods}
    \item {GPGN 329 - Physics of the Earth 2: Taught theory behind time-varying geophysical methods including electromagnetics and seismic.}
    \vspace{10pt}
    \end{cvitems}
  }
\cventry
